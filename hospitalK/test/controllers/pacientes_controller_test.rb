...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { apellidos: @paciente.apellidos, documento: @paciente.documento, fecha_nacimiento: @paciente.fecha_nacimiento, nombres: @paciente.nombres }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { apellidos: @paciente.apellidos, documento: @paciente.documento, fecha_nacimiento: @paciente.fecha_nacimiento, nombres: @paciente.nombres }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
