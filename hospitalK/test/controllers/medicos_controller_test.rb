...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { apellidos: @medico.apellidos, celular: @medico.celular, documento: @medico.documento, nombres: @medico.nombres, tipo_medico_id: @medico.tipo_medico_id }
    end
  ...
  test "should update medico" do
    patch :update, id: @medico, medico: { apellidos: @medico.apellidos, celular: @medico.celular, documento: @medico.documento, nombres: @medico.nombres, tipo_medico_id: @medico.tipo_medico_id }
    assert_redirected_to medico_path(assigns(:medico))
  end
